    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            case 'published':
                ...
                $update_to_publsih_status = mysqli_query($connection, $query);
                confirmQuery($update_to_publsih_status);
                break;
            case 'draft':
                $query = "UPDATE posts SET post_status = '{$bulk_options}' WHERE post_id = {$postValueId}";
    ...
    <form action="" method="post">
        <table class="table table-bordered table-hover">
            ...
            $query = "SELECT posts.post_id, posts.post_author, posts.post_title, posts.post_category_id, posts.post_status,
                        posts.post_image, posts.post_tags, posts.post_comment_count, posts.post_date, posts.post_views_count,
                        categories.cat_id, categories.cat_title 
                        FROM posts LEFT JOIN categories ON 
                        posts.post_category_id = categories.cat_id ORDER BY posts.post_id DESC";
